                ...
                <div className="flex items-center">
                  <div className="cashier-header-shortmenu pr-5 maxSm:pr-4 items-center flex flex-col justify-center custom-height-70">
                    <Link
                      ...
                      id="shortmenu"
                      href=""
                      className="h-10 w-10 leading-[38px] border border-grayBorder border-solid text-center inline-block rounded-[3px] text-bodyText short"
                    >
                    ...
                    >
                      <ul>
                        ...
                        <li>
                          <Link href="/team/add-members">Add Member</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="cashier-header-notify-wrapper px-5 flex items-center border-l border-solid border-grayBorder custom-height-70 pr-0">
                    ...
                    >
                      <Link id="notifydropdown" href="" className="noti">
                        <NotificationIcon />
                      </Link>
                    ...
                    >
                      <Link id="emaildropdown" href="" className="emai">
                        <EmailIcon />
                      </Link>
                      <div
