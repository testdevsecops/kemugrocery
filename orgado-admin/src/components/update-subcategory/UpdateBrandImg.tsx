...
const UpdateBrandImg = ({ myproduct, closeModal, setchangeImage }: any) => {
  ...
  const handleUpdate = () => {
    axios
      .put(`${process.env.BASE_URL}setting/brand-image?email=${user?.email}`, updateInfo,header)
      .then((res) => {
